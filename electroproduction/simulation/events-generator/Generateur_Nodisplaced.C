   ...
   for (int i = 0; i < nb_fichier; ++i) {
       ...
       for (Int_t n = 0; n < nb_event; n++) {
         ...
         if(t < -0.1 && t > -8 && Q2 < 8 && Q2 > 0.5){
            ...
            files[i] << setw(15) << pPip->E() << setw(15) << m_pi << setw(15) << 0. << setw(15) << 0. << setw(15) << vz << endl;
  
            // PI-
            files[i] << 4 << setw(5) << 1 << setw(5) << 1 << setw(7) << -211 << setw(5) << 0 << setw(5) << 0 << setw(15) << pPim->Px() << setw(15) << pPim->Py() << setw(15) << pPim->Pz();
            files[i] << setw(15) << pPim->E() << setw(15) << m_pi << setw(15) << 0. << setw(15) << 0. << setw(15) << vz << endl;
