...
filename = '/local/home/mr282803/Documents/irfu/diff_cs_new/diff_bins/fichier_bornes_bins.txt'
...
filename2 = '/local/home/mr282803/Documents/irfu/diff_cs_new/diff_bins/fichier_E_moy.txt'
...
with open("/local/home/mr282803/Documents/irfu/diff_cs_new/flux/F.txt", "w") as f:
    for valeur in Flux:
        f.write(f"{valeur}\n")
